...
class GassmaTransactionLockRequiredError extends Error {
  constructor() {
    super(
      "$transaction requires a lock. Pass `lock` when constructing GassmaClient, for example `new GassmaClient({ lock: LockService.getScriptLock() })`. The client generated by `npx gassma generate` does this for you.",
    );
    this.name = "GassmaTransactionLockRequiredError";
  }
}
