...
describe("notPatternFilter function tests", () => {
  ...
  const mockClassificationedRows: HitByClassificationedRowData[] = [
    {
      row: [{ age: 25, name: "Alice", city: "Tokyo", score: 85, category: "A" }],
      rowNumber: 1
    },
    {
    ...
    {
      row: [{ age: 22, name: "Charlie", city: "Tokyo", score: 78, category: "A" }],
      rowNumber: 3
    },
    {
      row: [{ age: 35, name: "David", city: "Kyoto", score: 88, category: "C" }],
      rowNumber: 4
    },
    {
  ...
  describe("equals condition filtering", () => {
    test("should filter by direct equals value", () => {
      ...
      expect(result.map(r => r.row[0].name)).toEqual(["Alice", "Charlie", "Eve"]);
    });
  ...
  describe("not condition filtering", () => {
    ...
    test("should filter by not condition with number", () => {
      ...
      expect(result.map(r => r.row[0].name)).toEqual(["Bob", "Charlie", "David", "Eve"]);
    });
  });
  ...
  describe("lt condition filtering", () => {
    ...
    test("should filter by lt condition with score", () => {
      ...
      expect(result).toHaveLength(3);
      expect(result.map(r => r.row[0].name)).toEqual(["Alice", "Charlie", "David"]);
    });
  });
  ...
  describe("contains condition filtering", () => {
    ...
    test("should filter by contains condition case sensitive", () => {
      ...
      expect(result).toHaveLength(4);
      expect(result.map(r => r.row[0].name)).toEqual(["Alice", "Charlie", "David", "Eve"]);
    });
  });
  ...
  describe("edge cases and error handling", () => {
    test("should handle empty having data", () => {
      ...
      expect(result.map(r => r.row[0].name)).toEqual(["Alice", "Bob", "Charlie", "David", "Eve"]);
    });
